<?php
    ...
    function requete_post($db, $post) {//post contient date, et midi/soir/matin
        ...
        $requete = "INSERT INTO `Personne` (`login`,`id_tranche_d_age`,`id_sexe`,`id_pratique`,`email`,`date_naissance`,`nom`,`admin`) VALUES (".$post['login'].",".$post['id_tranche_d_age'].$post['id_sexe'].",".$post['id_pratique'].$post['email'].",".$post['date_naissance'].$post['nom'].",0)";
        try{
